...
login_url = "https://passport.damai.cn/login?ru=https%3A%2F%2Fdetail.damai.cn%2Fitem.htm%3Fspm%3Da2oeg.home.card_0.ditem_0.591b23e1QEtgDU%26id%3D608137824452"
#抢票目标页
...
#target_url = "https://detail.damai.cn/item.htm?spm=a2oeg.home.card_0.ditem_0.362623e1araFyz&id=607728030501"
#target_url= "https://detail.damai.cn/item.htm?spm=a2oeg.home.card_0.ditem_0.591b23e1QEtgDU&id=608137824452"

target_url = "https://detail.damai.cn/item.htm?spm=a2oeg.project.searchtxt.ditem_1.281034380Gx91I&id=608512989862" # damanghe
name = "Your_Name"
    ...
    def choose_ticket(self):
        if self.status == 2:                  #登录成功入口
            ...
            while self.driver.title.find('确认订单') == -1:           #如果跳转到了订单结算界面就算这步成功了，否则继续执行此步
                ...
                try:
                    self.driver.find_elements_by_xpath('//div[@class = "perform__order__select perform__order__select__performs"]//div[2]//div//div[1]')[0].click()   #默认购票日期的选择,x为日期的选择，1，2，3....
                    # 场次 select first
                except:
                    print("场次")
                try:
                    self.driver.find_elements_by_xpath('//div[@class = "perform__order__select"]//div[2]//div//div//div')[0].click()   #默认购票日期的选择,x为日期的选择，1，2，3....
                except:
                    print("票档")
